...
percent_consumo = 29  # Percentual de consumo
...
ax.pie([percent_consumo, restante], 
       ...
       colors=['#FF5B5B', '#E0E0E0'])  # Verde e cinza claro
...
ax.text(0, -1.2, 'Consumo de energia total', ha='center', va='center', fontsize=10, fontweight='bold')
